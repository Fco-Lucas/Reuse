...
import com.lcsz.reuseplus.dtos.auth.AuthLoginDto;
import com.lcsz.reuseplus.exceptions.ExceptionMessage;
import com.lcsz.reuseplus.security.JwtToken;
import com.lcsz.reuseplus.security.JwtUserDetails;
import com.lcsz.reuseplus.security.JwtUserDetailsService;
    ...
    public ResponseEntity<?> auth(@RequestBody @Valid AuthLoginDto dto, HttpServletRequest request) {
        ...
        try {
            ...
            return ResponseEntity
                    .badRequest()
                    .body(new ExceptionMessage(request, HttpStatus.BAD_REQUEST, "Credênciais inválidas, certifique-se de possuir uma conta registrada com o CNPJ/CPF e senha informada"));
        }
    }
}
