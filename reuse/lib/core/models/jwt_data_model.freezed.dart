...
@JsonKey(name: 'sub') String get subject; int get iat;// Issued At
 ...
 String get id; AuthUserRole get role;
...
@useResult
$Res call({
@JsonKey(name: 'sub') String subject, int iat, int exp, String id, AuthUserRole role
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'sub')  String subject,  int iat,  int exp,  String id,  AuthUserRole role)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _JwtDataModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'sub')  String subject,  int iat,  int exp,  String id,  AuthUserRole role)  $default,) {final _that = this;
switch (_that) {
case _JwtDataModel():
return $default(_that.subject,_that.iat,_that.exp,_that.id,_that.role);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'sub')  String subject,  int iat,  int exp,  String id,  AuthUserRole role)?  $default,) {final _that = this;
switch (_that) {
case _JwtDataModel() when $default != null:
return $default(_that.subject,_that.iat,_that.exp,_that.id,_that.role);case _:
  return null;
...
@override final  AuthUserRole role;
