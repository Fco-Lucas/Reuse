...
part of 'home_action_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeActionState);
}
...
/// @nodoc
class $HomeActionStateCopyWith<$Res>  {
$HomeActionStateCopyWith(HomeActionState _, $Res Function(HomeActionState) __);
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function( HomePageActions action)?  loading,TResult Function( String message)?  success,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ActionInitial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function( HomePageActions action)  loading,required TResult Function( String message)  success,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _ActionInitial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function( HomePageActions action)?  loading,TResult? Function( String message)?  success,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _ActionInitial() when initial != null:
return initial();case _ActionLoading() when loading != null:
return loading(_that.action);case _ActionSuccess() when success != null:
...
class _ActionInitial implements HomeActionState {
...
@override
String toString() {
  return 'HomeActionState.initial()';
}
...
class _ActionLoading implements HomeActionState {
  const _ActionLoading(this.action);
  

 final  HomePageActions action;
...
@override
String toString() {
  return 'HomeActionState.loading(action: $action)';
}
...
class _ActionSuccess implements HomeActionState {
...
@override
String toString() {
  return 'HomeActionState.success(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ActionSuccessCopyWith<$Res> implements $HomeActionStateCopyWith<$Res> {
...
class _ActionError implements HomeActionState {
...
@override
String toString() {
  return 'HomeActionState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ActionErrorCopyWith<$Res> implements $HomeActionStateCopyWith<$Res> {
