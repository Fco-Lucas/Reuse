...
part of 'restaurant_profile_action_state.dart';
...
/// @nodoc
mixin _$RestaurantProfileActionState {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RestaurantProfileActionState);
}
...
@override
String toString() {
  return 'RestaurantProfileActionState()';
}
...
/// @nodoc
class $RestaurantProfileActionStateCopyWith<$Res>  {
$RestaurantProfileActionStateCopyWith(RestaurantProfileActionState _, $Res Function(RestaurantProfileActionState) __);
}


/// Adds pattern-matching-related methods to [RestaurantProfileActionState].
extension RestaurantProfileActionStatePatterns on RestaurantProfileActionState {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function( RestaurantProfilePageActions action)?  loading,TResult Function( String message)?  success,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ActionInitial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function( RestaurantProfilePageActions action)  loading,required TResult Function( String message)  success,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _ActionInitial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function( RestaurantProfilePageActions action)?  loading,TResult? Function( String message)?  success,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _ActionInitial() when initial != null:
return initial();case _ActionLoading() when loading != null:
return loading(_that.action);case _ActionSuccess() when success != null:
...
class _ActionInitial implements RestaurantProfileActionState {
...
@override
String toString() {
  return 'RestaurantProfileActionState.initial()';
}
...
class _ActionLoading implements RestaurantProfileActionState {
  const _ActionLoading(this.action);
  

 final  RestaurantProfilePageActions action;

/// Create a copy of RestaurantProfileActionState
...
@override
String toString() {
  return 'RestaurantProfileActionState.loading(action: $action)';
}
...
/// @nodoc
abstract mixin class _$ActionLoadingCopyWith<$Res> implements $RestaurantProfileActionStateCopyWith<$Res> {
  factory _$ActionLoadingCopyWith(_ActionLoading value, $Res Function(_ActionLoading) _then) = __$ActionLoadingCopyWithImpl;
@useResult
$Res call({
 RestaurantProfilePageActions action
});
...
as RestaurantProfilePageActions,
  ));
}
...
class _ActionSuccess implements RestaurantProfileActionState {
...
@override
String toString() {
  return 'RestaurantProfileActionState.success(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ActionSuccessCopyWith<$Res> implements $RestaurantProfileActionStateCopyWith<$Res> {
...
class _ActionError implements RestaurantProfileActionState {
...
@override
String toString() {
  return 'RestaurantProfileActionState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ActionErrorCopyWith<$Res> implements $RestaurantProfileActionStateCopyWith<$Res> {
