...
part of 'restaurant_profile_state.dart';
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<PostUserListResponseModel> posts,  bool hasMorePages,  RestaurantProfileActionState actionState,  bool isLoadingMore,  String? paginationError)?  data,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<PostUserListResponseModel> posts,  bool hasMorePages,  RestaurantProfileActionState actionState,  bool isLoadingMore,  String? paginationError)  data,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<PostUserListResponseModel> posts,  bool hasMorePages,  RestaurantProfileActionState actionState,  bool isLoadingMore,  String? paginationError)?  data,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Data() when data != null:
...
class _Loading implements RestaurantProfileState {
  const _Loading();
...
class _Data implements RestaurantProfileState {
  const _Data({required final  List<PostUserListResponseModel> posts, required this.hasMorePages, this.actionState = const RestaurantProfileActionState.initial(), this.isLoadingMore = false, this.paginationError}): _posts = posts;
...
@JsonKey() final  RestaurantProfileActionState actionState;
...
@override
String toString() {
  return 'RestaurantProfileState.data(posts: $posts, hasMorePages: $hasMorePages, actionState: $actionState, isLoadingMore: $isLoadingMore, paginationError: $paginationError)';
}
...
/// @nodoc
abstract mixin class _$DataCopyWith<$Res> implements $RestaurantProfileStateCopyWith<$Res> {
  factory _$DataCopyWith(_Data value, $Res Function(_Data) _then) = __$DataCopyWithImpl;
@useResult
$Res call({
 List<PostUserListResponseModel> posts, bool hasMorePages, RestaurantProfileActionState actionState, bool isLoadingMore, String? paginationError
});


$RestaurantProfileActionStateCopyWith<$Res> get actionState;
...
as RestaurantProfileActionState,isLoadingMore: null == isLoadingMore ? _self.isLoadingMore : isLoadingMore // ignore: cast_nullable_to_non_nullable
...
$RestaurantProfileActionStateCopyWith<$Res> get actionState {
  ...
  return $RestaurantProfileActionStateCopyWith<$Res>(_self.actionState, (value) {
...
class _Error implements RestaurantProfileState {
...
@override
String toString() {
  return 'RestaurantProfileState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $RestaurantProfileStateCopyWith<$Res> {
