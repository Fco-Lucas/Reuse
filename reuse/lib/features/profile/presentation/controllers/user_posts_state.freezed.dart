...
class _Initial implements UserPostsState {
  const _Initial();
...
class _Loading implements UserPostsState {
  const _Loading();
...
class _Data implements UserPostsState {
...
@override
String toString() {
  return 'UserPostsState.data(posts: $posts, hasMorePages: $hasMorePages, isLoadingMore: $isLoadingMore, paginationError: $paginationError)';
}
...
/// @nodoc
abstract mixin class _$DataCopyWith<$Res> implements $UserPostsStateCopyWith<$Res> {
...
class _Error implements UserPostsState {
...
@override
String toString() {
  return 'UserPostsState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $UserPostsStateCopyWith<$Res> {
