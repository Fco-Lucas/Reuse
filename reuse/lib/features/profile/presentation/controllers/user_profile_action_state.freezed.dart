...
part of 'user_profile_action_state.dart';
...
/// @nodoc
mixin _$UserProfileActionState {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserProfileActionState);
}
...
/// @nodoc
class $UserProfileActionStateCopyWith<$Res>  {
$UserProfileActionStateCopyWith(UserProfileActionState _, $Res Function(UserProfileActionState) __);
}


/// Adds pattern-matching-related methods to [UserProfileActionState].
extension UserProfileActionStatePatterns on UserProfileActionState {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function( UserProfilePageActions action)?  loading,TResult Function( String message)?  success,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ActionInitial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function( UserProfilePageActions action)  loading,required TResult Function( String message)  success,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _ActionInitial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function( UserProfilePageActions action)?  loading,TResult? Function( String message)?  success,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _ActionInitial() when initial != null:
return initial();case _ActionLoading() when loading != null:
return loading(_that.action);case _ActionSuccess() when success != null:
...
class _ActionInitial implements UserProfileActionState {
...
@override
String toString() {
  return 'UserProfileActionState.initial()';
}
...
class _ActionLoading implements UserProfileActionState {
  const _ActionLoading(this.action);
  

 final  UserProfilePageActions action;

/// Create a copy of UserProfileActionState
...
@override
String toString() {
  return 'UserProfileActionState.loading(action: $action)';
}
...
/// @nodoc
abstract mixin class _$ActionLoadingCopyWith<$Res> implements $UserProfileActionStateCopyWith<$Res> {
  factory _$ActionLoadingCopyWith(_ActionLoading value, $Res Function(_ActionLoading) _then) = __$ActionLoadingCopyWithImpl;
@useResult
$Res call({
 UserProfilePageActions action
});
...
class _ActionSuccess implements UserProfileActionState {
...
@override
String toString() {
  return 'UserProfileActionState.success(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ActionSuccessCopyWith<$Res> implements $UserProfileActionStateCopyWith<$Res> {
...
class _ActionError implements UserProfileActionState {
...
@override
String toString() {
  return 'UserProfileActionState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ActionErrorCopyWith<$Res> implements $UserProfileActionStateCopyWith<$Res> {
